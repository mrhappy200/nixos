  ...
  xdg.configFile = {
    "tofi/config".text = ''
      ...
      #
      	...
      	font = "/home/mrhappy200/.nix-profile/share/fonts/truetype/NerdFonts/FiraCodeNerdFontMono-Retina.ttf"
      ...
      #
      	...
      	# Selection text
      	selection-color = #${config.lib.stylix.colors.base05}
      	selection-background = #${config.lib.stylix.colors.base00}
      	selection-background-padding = 0
      	selection-background-corner-radius = 2

      	# Matching portion of selection text
      	selection-match-color = #${config.lib.stylix.colors.base04}
