{ lib, config, pkgs, ... }: {
  ...
  wayland.windowManager.hyprland = {
    ...
    settings =
      let
        active = "0xaa${config.lib.stylix.colors.base0C}";
        inactive = "0xaa${config.lib.stylix.colors.base02}";
      in
      {
        general = {
        ...
        group = {
          "col.border_active" = lib.mkForce active;
          "col.border_inactive" = lib.mkForce inactive;
